  ...
  return (
    <main className="bg-[#F4FAFA] text-[#002C3E] min-h-screen">
      <section className="flex flex-col items-center text-center min-h-[90vh] px-6 bg-gradient-to-b from-[#F4FAFA] to-[#E7F7F6] pt-24">
        ...
        {/* Search (no hooks, no router—classic GET to /searchresults) */}
        <form action="/searchresults" method="GET" className="flex justify-center items-center mb-12">
          <input
            type="text"
            name="query"
            placeholder="Search ETS Records"
            className="w-[750px] rounded-l-full border border-gray-300 text-gray-700 text-lg px-6 py-3.5 focus:outline-none focus:ring-2 focus:ring-[#2FA8A3] shadow-sm"
          />
          <button
            type="submit"
            className="bg-[#2FA8A3] hover:bg-[#24938f] text-white font-medium rounded-r-full px-8 py-[13px] text-lg transition-colors border border-[#2FA8A3] -ml-[1px]"
          >
            Search
          </button>
        </form>
